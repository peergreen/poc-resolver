...
public class FeatureRequirement implements Requirement {
	...
	public FeatureRequirement(Resource resource, String name) {
		this.name = name;
		this.resource= resource;
		attributes.put(getNamespace(), name);
		directives.put(
				ExecutionEnvironmentNamespace.REQUIREMENT_FILTER_DIRECTIVE,
                "(" + ExecutionEnvironmentNamespace.EXECUTION_ENVIRONMENT_NAMESPACE + "=" + name + ")");
	...
	public String toString() {
		return "FeatureRequirement[".concat(name).concat("]");
	}
}
